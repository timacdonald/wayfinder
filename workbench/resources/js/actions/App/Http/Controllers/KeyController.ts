 ...
 * @see /Users/tim/Code/wayfinder/workbench/app/Http/Controllers/KeyController.php:7
 */
export const show: {
    definition: {
        methods: ('get'|'head')[],
 ...
 * @see /Users/tim/Code/wayfinder/workbench/app/Http/Controllers/KeyController.php:12
 */
export const edit: {
    definition: {
        methods: ('get'|'head')[],
