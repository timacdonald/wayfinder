 ...
 * @see /Users/tim/Code/wayfinder/workbench/app/Http/Controllers/ParameterNameController.php:7
 */
export const camel: {
    definition: {
        methods: ('get'|'head')[],
 ...
 * @see /Users/tim/Code/wayfinder/workbench/app/Http/Controllers/ParameterNameController.php:12
 */
export const studly: {
    definition: {
        methods: ('get'|'head')[],
 ...
 * @see /Users/tim/Code/wayfinder/workbench/app/Http/Controllers/ParameterNameController.php:17
 */
export const snake: {
    definition: {
        methods: ('get'|'head')[],
 ...
 * @see /Users/tim/Code/wayfinder/workbench/app/Http/Controllers/ParameterNameController.php:22
 */
